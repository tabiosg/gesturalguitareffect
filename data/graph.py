...
axs[0, 1].legend(labels=['Raw Potent'], loc='lower right')
axs2_01.legend(labels=['Tremolo Depth'], loc='upper right')

# Plotting Time vs. potentiometer and delay repeats
axs[1, 0].plot(time_points, graphs_data["POTENTRAWTOREPEATS"][0], color='blue')
axs[1, 0].set_title('Time vs. Raw Potentiometer and Delay Repeats')
...
axs[1, 0].legend(labels=['Raw Potent'], loc='lower right')
axs2_10.legend(labels=['Delay Repeats'], loc='upper right')

# Plotting Time vs. raw accel and degrees
axs[1, 1].plot(time_points, graphs_data["ACCELRAWTODEG"][0], color='blue')
axs[1, 1].set_title('Time vs. Raw Acceleration and Acceleration Degrees')
...
axs[1, 1].legend(labels=['Raw Accel'], loc='lower right')
axs2_11.legend(labels=['Accel Degrees'], loc='upper right')
...
axs[2, 1].legend(labels=['Accel Degrees'], loc='lower right')
axs2_21.legend(labels=['Possible Delay Length'], loc='upper right')
